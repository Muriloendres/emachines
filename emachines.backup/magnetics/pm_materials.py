...
class MagnetData:
    ...
    def plot_JH(self):
        ...
        fig = go.Figure()
        fig.add_trace(go.Scatter(x=self.H, y=self.J,     mode='lines',
                                 name='J-H curve',       line=dict(color='cyan')))
        fig.add_trace(go.Scatter(x=self.H, y=self.B,     mode='lines',
                                 name='B-H curve',       line=dict(color='magenta')))
        fig.add_trace(go.Scatter(x=self.H, y=self.J_20C, mode='lines',
                                 name='J-H curve (20°C)',
                                 line=dict(dash='dash', color='cyan')))
        fig.add_trace(go.Scatter(x=self.H, y=self.B_20C, mode='lines',
                                 name='B-H curve (20°C)',
